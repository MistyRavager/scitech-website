(function() {
  ...
  $('.nav-icon').addEventListener('click', function() {
    ...
    if (menuActive) {
      ...
      this.querySelector('i:nth-of-type(1)').style.display = 'inline-block'
      this.querySelector('i:nth-of-type(2)').style.display = 'none'
      menuActive = false
    } else {
      // this.querySelector('img:nth-of-type(1)').style.display = 'none'
      // this.querySelector('img:nth-of-type(2)').style.display = 'inline-block'
      this.querySelector('i:nth-of-type(1)').style.display = 'none'
      this.querySelector('i:nth-of-type(2)').style.display = 'inline-block'
      menuActive = true
    }
  })
